# Day 58: 韌體工程師白板題特訓 Part 1 (C 語言工具箱複習、二進位 1 的計數極速法、單向鏈結串列 3 指標原地反轉)

今天是韌體工程師白板手寫程式碼 (Whiteboard Coding) 特訓第一天。我們先全面溫習了 5 大高頻 C 語言語法工具箱，隨後進行了白板題第 1 題與第 2 題的觀念拆解、實作、Code Review 與邊界陷阱檢討。
